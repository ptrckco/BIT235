		        ...
		        try {
		          ...
		          // Step 2:Create a statement using connection object
		            ...
		            while (rs.next()) {
		                ...
		                book = new Book(bid, booktitle, cid, description, author, publisheddate, isbn, price, noofpages);
		            }
		        } catch (SQLException e) {
		            printSQLException(e);
		        }
		    ...
		    public List < Book > selectAllBooks() {
		        ...
		        try { 
		            ...
		            while (rs.next()) {
		                ...
		                books.add(new Book(bid, booktitle, cid, description, author, publisheddate, isbn, price, noofpages));
		            }
		        } catch (SQLException e) {
		            printSQLException(e);
		        }
