...
<body style = "font-family:arial,serif;">
    <div align="center" cellpadding=10>
		...
		<p align = "right">
 		...
 		<form action="BookListServlet?action=category=" method="get">
		<p align= "right">
		<select name="category">
						<c:forEach items="${category}" var="category">
							<option value="${category.cid}" selected >${category.categorytitle}</option>
						</c:forEach>
					</select>
		...
		<p align = "right">
			...
			<input type="text" placeholder="Enter Category Title" name="category">
