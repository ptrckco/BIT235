...
<body style = "font-family:arial,serif;">
    <div align="center" cellpadding=10>
        ...
        <table  >
         ...
         <a href="${pageContext.request.contextPath}/AdminBookCategoryServlet">Category List</a>
        </h4>
 		</center>
            ...
            <c:forEach var="book" items="${listBook}">
                <tr align=center>
                    ...
                    <td>
                     ...
                     |<a href="#" onclick="deleteBook(${book.getbid()})">Delete</a>|                     
                    </td>
                </tr>
            </c:forEach>
        </table>
...
function deleteBook(id){
    if(confirm('Are you sure to delete this book?')){
       window.location.href="${pageContext.request.contextPath}/AdminBookListServlet?action=delete&id="+id;
    } 
}
</script>
</html>