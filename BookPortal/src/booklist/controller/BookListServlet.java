...
public class BookListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            case "search":
                ...
                break;
            case "category":
                showBookCategory(request, response);
                break;
            case "select":
	...
	private void showBookCategory(HttpServletRequest request, HttpServletResponse response)  throws SQLException, ServletException, IOException {
		   String category = request.getParameter("category");
		   List < BookList > existingBook = booklistDAO.searchBookCategory(category);
		 RequestDispatcher dispatcher = request.getRequestDispatcher("booklist.jsp");
		 request.setAttribute("listBook", existingBook);
		 dispatcher.forward(request, response);
		}
