...
public class BookList {
    ...
    public BookList(int bid, String booktitle, int cid, String description, String author, Timestamp publisheddate, String isbn, float price, int noofpages, String category) {
    	this.bid = bid;
        this.cid = cid;
        this.booktitle = booktitle;       
        this.description = description;
